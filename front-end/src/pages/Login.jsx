  ...
  return (
    <form onSubmit={submitHandler}
      ...
      {currentState === 'Login' ? '' : <input type="text" onChange={(e) => { setName(e.target.value) }} value={name}
        className='w-full px-3 py-2 border border-gray-800' placeholder='Username' required={true} />}
      <input type="email" className='w-full px-3 py-2 border border-gray-800' onChange={(e) => { setEmail(e.target.value) }}
        placeholder='Email' value={email} required={true} />
      <input type="password" className='w-full px-3 py-2 border border-gray-800' onChange={(e) => { setPassword(e.target.value) }}
