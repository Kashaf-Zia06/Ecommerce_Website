    ...
    <form className='flex  flex-col gap-3 w-full items-start'>
      ...
      <div className='w-full'>
        ...
        <input onChange={(e)=>{setName(e.target.value)}} value={name}
         required={true} className='w-full max-w-[500px] px-3 py-2' 
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
        ...
        <div>
          <p className='mb-2'>SubCategory</p>
            <select className='px-3 py-2 w-full' onChange={(e)=>{setSubCategory(e.target.value)}} >
        ...
        <div>
          ...
          type="Number" name="" id="" placeholder='25' /> 
        </div>
      ...
      <div>
        ...
        <div className='flex gap-3'>
          <div onClick={()=>setSizes(prev=>prev.includes('S')?prev.filter(item=>item!=='S'):[...prev,'S'])}>
            <p className={`${sizes.includes('S')?'bg-pink-100':'bg-slate-200'} px-3 py-2 cursor-pointer`} 
            >S</p>
          </div>
